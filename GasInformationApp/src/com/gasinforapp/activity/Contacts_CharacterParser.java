 ...
 * Java汉字转换为拼音
 */
public class Contacts_CharacterParser {
	...
	private static Contacts_CharacterParser characterParser = new Contacts_CharacterParser();

	public static Contacts_CharacterParser getInstance() {
