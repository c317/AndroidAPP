...
public class ToDoAffairsAdapter extends BaseAdapter {
	private Context context;
	private List<Affairs> affairsList;

	public ToDoAffairsAdapter(Context context, List<Affairs> affairsList) {
